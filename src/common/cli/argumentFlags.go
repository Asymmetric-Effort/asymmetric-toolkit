...
const ( //Reserved 0...1000 for core use.  1000+ are program-defined.
	...
	FlagInputFile   ArgumentFlag = 15 // Provides an input filename for general, unspecified use.
	FlagOutputFile  ArgumentFlag = 16 // Provides an output filename for general, unspecified use.
